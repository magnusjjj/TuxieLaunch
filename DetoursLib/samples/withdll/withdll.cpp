...
//
#pragma warning(disable:4530) // /analyze warnings
#include <stdio.h>
#include <windows.h>
#include <detours.h>
...
#pragma warning(push)
#if _MSC_VER > 1400
#pragma warning(disable:6102 6103 4530) // /analyze warnings
#endif
#include <strsafe.h>
#pragma warning(pop)
#include <iostream>
...
int CDECL main(int argc, char **argv)
{
	...
	std::vector<option::Option> optionbuffer(stats.buffer_max);
	option::Parser parse(usage, argc, argv, &options[0], &optionbuffer[0]);
